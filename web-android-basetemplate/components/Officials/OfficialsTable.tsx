...
export default function OfficialsTable({
  ...
  // Encapsulated filter/pagination settings
  ...
  // Dynamic calculations for sorting options and text indexing
  ...
  return (
    <View style={{ flex: 1, paddingHorizontal: tokens.spacing.xl || 25 }}>
      ...
      <View style={{ flex: 1, width: '100%', }}>
        <View
          style={{
            ...
            overflow: 'hidden',
            borderWidth:theme.layout.dividerHeight,
